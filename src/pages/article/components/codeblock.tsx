...
import { ClassAttributes, FunctionComponent, HTMLAttributes, MutableRefObject, useRef } from 'react';
...
> = ({ node, children, buttons, ...props }) => {
  ...
  useCodeBlock({ ref, node, code, buttons });
